...
def showCredit():
    ...
    try:
        ...
        if overallAcc >= 90:
            showInstructions(text = ["Your overall accuracy was {:.0f}%. You've earned {} credits for yourself, and {} credits for charity.".format(overallAcc, creditSelf, creditCharity),
            "These credits convert to ${:.2f} for yourself, and ${:.2f} donated to your charity. We will email you your reward in the form of an Amazon voucher, and will help you donate to {}.".format(moneySelf, moneyCharity, charityChosen)])
        else:
            showInstructions(text = ["Your overall accuracy was {:.0f}%. Although you've earned {} credits for yourself, and {} credits for charity, these credits won't be converted to money and neither you nor your charity will be paid because you need to be at least 90% accurate.".format(overallAcc, creditSelf, creditCharity)])
        ...
        showInstructions(text = ["Your overall accuracy was 91%. The credits you've earned have been converted to $3.50 for yourself, and $2.80 donated to your charity. We will email you your reward in the form of an Amazon voucher, and will help you donate to {}.".format(charityChosen)])
...
''' practice '''
showInstructions(text =
["We are studying how people make decisions related to cognitive effort. You'll have many opportunities to earn money during the experiment.",
...
"Now, you can choose which (of 5) charities you want to donate to. If you have a specific charity you'd like to donate to, let the research assistant know. "
])
...
runEffortRewardChoiceBlock(taskName='effortRewardChoicePractice', blockType='mixed', reps=1, feedback=True, saveData=True, practiceTrials=10, titrate=False, rtMaxFrames=300, blockMaxTimeSeconds=60, experimentMaxTimeSeconds=None, reward=[2, 5, 1], effort=[2, 7])
